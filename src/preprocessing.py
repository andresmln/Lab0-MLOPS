# Imports
import math
from numpy import nan # Usamos numpy.nan para compatibilidad, aunque math.nan también vale
import re
import random
...
def clip_values(data: list, min_val: float, max_val: float) -> list:
    ...
    """
    if min_val > max_val:
        raise ValueError("El valor mínimo (min_val) no puede ser mayor que el valor máximo (max_val).")
